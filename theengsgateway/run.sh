...
PRESENCE=$( [ "$(bashio::config 'PRESENCE')" = "true" ] && echo 1 || echo 0 )
PUBLISH_ALL=$( [ "$(bashio::config 'PUBLISH_ALL')" = "true" ] && echo 1 || echo 0 )
PUBLISH_ADVDATA=$( [ "$(bashio::config 'PUBLISH_ADVDATA')" = "true" ] && echo 1 || echo 0 )
SCAN_DUR=$(bashio::config 'SCAN_DUR')
TIME_BETWEEN=$(bashio::config 'TIME_BETWEEN')
LOG_LEVEL=$(bashio::config 'LOG_LEVEL')
DISCOVERY=$( [ "$(bashio::config 'DISCOVERY')" = "true" ] && echo 1 || echo 0 )
...
TIME_FORMAT=$( [ "$(bashio::config 'TIME_FORMAT')" = "true" ] && echo 1 || echo 0 )
